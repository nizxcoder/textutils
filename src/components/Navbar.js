    ...
    <div style={props.mode}>
      <nav className="navbar navbar-expand-lg border" style={props.mode}>
        <div className="container-fluid">
          <Link className="navbar-brand" style={props.mode} to="/textutils/">{props.title}</Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0" >
              <li className="nav-item">
                <Link className="nav-link active" style={props.mode} aria-current="page" to="/textutils/">Home</Link>
              </li>
              <li className="nav-item">
                <Link to="/textutils/textform" className="nav-link" style={props.mode} >{props.name}</Link>
              </li>
              <li className="nav-item" >
                <Link className="nav-link" style={props.mode} to="/textutils/about">About</Link>
              </li>
            ...
            <button className='btn mx-1' onClick={() => { { props.changeMode('🟡') } }} style={{ fontSize: "23px", padding: "0px" }} title="Change Mode">🟡</button>
            <button className='btn mx-1' onClick={() => { { props.changeMode('🔵') } }} style={{ fontSize: "23px", padding: "0px" }} title="Change Mode">🔵</button>
            <button className='btn mx-1' onClick={props.changeMode} style={{ fontSize: "23px", padding: "0px" }} title="Change Mode">{props.text}</button>
